...
public class BasicHashTable <X, Y>{
    ...
    public Y get(X key){
        ...
        // if we don't have anything for this key then return null
        if(data[hash] == null){
            return null;
        }else{
    ...
    public Y delete(X key){
        ...
        if(value != null){
            ...
            // If next slot isn't empty we should re add it so we can keep the hash algorithms clean
    ...
    private int calculateHash(X key){
        ...
        // this is necessary to prevent collisions
